...
/** An example of the *shape* of a value, for the empty control. Anything that
 *  explains rather than demonstrates belongs in INFO. */
export const EXAMPLE = {
  ...
  aliases: {
    product: 'portal, "the web app"',
    component: 'lc, LC, "line controller"',
    customer: "Oettinger, Davidoff",
  },
...
export const INFO = {
  ...
  aliases: {
    product:
      "Other names this product answers to, comma-separated. The agent and the API resolve them like the slug.",
    component:
      "Other names this component answers to, comma-separated. They also match knowledge and reference entries tagged with the variant.",
    customer:
      "Other NAMES this account trades under, comma-separated. Not email domains, which have their own field.",
  },
  emailDomains:
    "Domains whose senders are this customer, comma-separated, including a partner or distributor who raises tickets on their behalf. Incoming tickets are attributed by the requester's domain, and a domain listed on two customers deliberately matches neither, so a shared integrator's domain belongs to nobody.",
  parent:
