...
export type Component = { id: string; parent_id: string | null; slug: string; name: string; description: string | null; aliases: string[] | null };
export type Label = { id: string; slug: string; description: string | null };
export type Customer = { id: string; slug: string; name: string; aliases: string[] | null; notes: string | null };
export type Pattern = { slug: string; description: string };
export type Connection = { id: string; source_type: string; slug: string; base_url: string | null; config: Record<string, unknown> | null };
export type ProductMap = { id: string; source_slug: string; external_group_key: string; product_slug: string; product_name: string };
...
export type Member = { user_id: string; email: string; display_name: string | null; team_role: string };
...
export const aliasText = (a: string[] | null) => (a?.length ? a.join(", ") : "");
