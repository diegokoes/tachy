...
**Slow search.** Admin › access › system settings: event-loop delay and the embedding queue. A
...
**A stuck or expensive turn.** Admin › access › system settings shows slots, queued turns and
...
directly. Admin › connect › sources lists auth failures and rate limits per
connection.
...
**Memory.** Admin › access › system settings: api memory against its limit. Each Claude turn
